...
- `data/processed/`: de-identified processed video-level data and sample indexes.
...
- Identifiable local processed CSV files containing platform video IDs, author names, titles, local paths, or other platform-level identifiers.
...
Raw videos, user comments, extracted frames, local paths, and identifiable row-level video records should not be published in the public repository. The public materials document the workflow, de-identified processed data, and aggregate results.
